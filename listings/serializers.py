...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Payment
        fields = [
            'id', 'booking', 'booking_id', 'reference', 'transaction_id',
            'amount', 'status', 'created_at', 'updated_at'
        ]
        read_only_fields = ['created_at', 'updated_at', 'reference']
...
class ListingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'capacity', 'amenities', 'availability_start', 'availability_end',
            'is_available', 'created_at', 'updated_at', 'reviews', 'bookings',
            'average_rating'
        ]
